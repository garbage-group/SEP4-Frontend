...
describe("BinList component", () => {
    const mockBins = [
        { id: 1, capacity: 200, emptiedLast: new Date("2023-01-01T12:00:00Z"), latitude: 123, longitude: 456 },
        { id: 2, capacity: 200, emptiedLast: new Date("2023-01-01T12:00:00Z"), latitude: 123, longitude: 456 },
    ];
